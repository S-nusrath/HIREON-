...
//             Profile
//           </Link>
//           <Link to="/discover" className="block hover:text-indigo-400">
//             discover
//           </Link>
//           <Link to="/connections" className="block hover:text-indigo-400">
//             Connections
//           </Link>
//           <Link to="/resume" className="block hover:text-indigo-400">
//             resume
//           </Link>
//           <Link to="/practice" className="block hover:text-indigo-400">
//             Practice
//           </Link>
//         </nav>
//       </aside>
...
export default function MainLayout() {
  ...
  // Safe user object (prevents crashes)
  const safeUser = user || {};
